...
| [Классификация токсичных комментариев](https://github.com/suuurfinbird/yandex-data-science-projects-2023/tree/main/toxic_comments) | Анализ комментариев пользователей интернет-магазина на токсичность. | *python*, *pandas*, *bert*, *nltk*, *tf-idf*
