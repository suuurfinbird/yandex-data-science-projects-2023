...
## Выводы
Проведено исследование моделей для предсказания температуры стали. Выбрана лучшая модель с **MAE** 5.1 - StackingSVRegressor c регрессорами Lasso, Ridge и LightGBM, мета-регрессор - CatBoost
